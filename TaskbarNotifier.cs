...
namespace TimeTracker
{
    ...
    public class TaskbarNotifier : System.Windows.Forms.Form
    {
        ...
        protected double nIncrementShow;
        protected double nIncrementHide;
        ...
        protected bool bReShowOnMouseOver = true;				// Added Rev 002
        #endregion
        ...
        public void Show(string strTitle, string strContent, int nTimeToShow, int nTimeToStay, int nTimeToHide)
        {
            ...
            switch (taskbarState)
            {
                case TaskbarStates.hidden:
                    ...
                    SetBounds(WorkAreaRectangle.Right - BackgroundBitmap.Width - 17, WorkAreaRectangle.Bottom - 1 - BackgroundBitmap.Height, BackgroundBitmap.Width, BackgroundBitmap.Height);
                    this.Opacity = 0;
        ...
        public void SetBackgroundBitmap(string strFilename, Color transparencyColor)
        {
            ...
            SetBackgroundBitmap(BackgroundBitmap, transparencyColor);
        }
        ...
        /// Sets the background bitmap and its transparency color
        /// </summary>
        /// <param name="image">Bitmap object which represents the Background Bitmap</param>
        /// <param name="transparencyColor">Color of the Bitmap which won't be visible</param>
        /// <returns>Nothing</returns>
        ...
        public void SetCloseBitmap(string strFilename, Color transparencyColor, Point position)
        {
            ...
            SetCloseBitmap(CloseBitmap, transparencyColor, position);
        }
        ...
        /// Sets the 3-State Close Button bitmap, its transparency color and its coordinates
        /// </summary>
        /// <param name="image">Bitmap object which represents the 3-state Close button Bitmap (width must be a multiple of 3)</param>
        /// <param name="transparencyColor">Color of the Bitmap which won't be visible</param>
        /// /// <param name="position">Location of the close button on the popup</param>
        /// <returns>Nothing</returns>
